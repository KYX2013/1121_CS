...
namespace Problem13
{
    public partial class P9 : Form
    {
        ...
        public P9()
        {
            ...
            this.FormClosing += P9_FormClosing;
        }

        private void P9_FormClosing(object? sender, FormClosingEventArgs e)
        {
            if(restart) {
                P9 p9 = new P9();
                p9.MdiParent = this.MdiParent;
                p9.Show();
            }
        }
